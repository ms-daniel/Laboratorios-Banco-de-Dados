...
SELECT D.NOME AS 'DEPARTAMENTO',  F.NOME AS 'DIRETOR_DEPARTAMENTO', C.NOME AS 'CAMPUS', F2.NOME AS 'DIRETOR_CAMPUS'
...
--CAMPUS E ENDEREÇOS
SELECT C.NOME AS 'CAMPUS', E.CIDADE, E.RUA, ISNULL(STR(E.NUMERO), 'S/N') AS 'NUMERO', C.TELEFONE
